...
Item {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Controls.Dropdown {
                    ...
                    onSelected: (index, value) => ConfigStore.patch(
                        "modules.spotlight.pageTransition", value)
                }
            }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    Layout.fillWidth: true
                    Controls.TextLabel {
                        text: I18n.tr("settings.spotlight.transition_duration")
                        strong: true
                    }
                ...
                Controls.Slider {
                    ...
                    onMoved: value => ConfigStore.patch(
                        "modules.spotlight.transitionDuration", Math.round(value))
                }
            }
        }
        ...
        Controls.TextLabel {
            text: I18n.tr("settings.spotlight.applications.title")
            variant: "title"
            strong: true
        }
        Controls.TextLabel {
            Layout.fillWidth: true
            text: I18n.tr("settings.spotlight.applications.description")
            variant: "body"
            tone: "secondary"
            wrapMode: Text.WordWrap
        }
