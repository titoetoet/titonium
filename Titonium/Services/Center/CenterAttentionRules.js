...
var POLICY = Object.freeze({
    ...
    "center:feedback": Object.freeze({ priority: 10, ttl: 2000, actionable: false }),
    ...
    "job:job_completed": Object.freeze({ priority: 40, ttl: 5000, actionable: false }),
    "timer:timer_five_minutes": Object.freeze({ priority: 30, ttl: 4000, actionable: false }),
    "timer:timer_one_minute": Object.freeze({ priority: 30, ttl: 6000, actionable: false }),
    "media:track_changed": Object.freeze({ priority: 20, ttl: 6000, actionable: false }),
    "media:resumed": Object.freeze({ priority: 20, ttl: 3000, actionable: false }),
    "media:paused": Object.freeze({ priority: 20, ttl: 2000, actionable: false }),
    "job:job_started": Object.freeze({ priority: 10, ttl: 2000, actionable: false }),
});
